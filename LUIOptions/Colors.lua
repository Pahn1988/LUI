...
local Colors = Opt:CreateModuleOptions("Colors", module)
Colors.order = 2
...
Colors.args = {
    ...
    Class = Opt:Group({name = L["Colors_Classes"], args = {
        ...
        --Secondary Class Powers Section
    ...
    -- Factions Color Tab
    Factions = Opt:Group({name = L["Colors_Factions"], args = {
    ...
    -- Misc. Color Tab
    Misc = Opt:Group({name = MISCELLANEOUS, args = {
