...
Micromenu.args = {
	...
	HidePlayer = Opt:Toggle({name = L["MicroOptions_Player"], hidden = function() return not module:IsClientButtonAvailable("Player") end}),
	HideSpellbook = Opt:Toggle({name = L["MicroOptions_Spellbook"], hidden = function() return not module:IsClientButtonAvailable("Spellbook") end}),
	HideLegacy = Opt:Toggle({name = _G.LEGACY_BUTTON or "Legacy", hidden = function() return not module:IsClientButtonAvailable("Legacy") end}),
	HideTalents = Opt:Toggle({name = L["MicroOptions_Talents"]}),
	HideAchievements = Opt:Toggle({name = L["MicroOptions_Achievements"], hidden = function() return not module:IsClientButtonAvailable("Achievements") end}),
	HideQuests = Opt:Toggle({name = L["MicroOptions_Quests"], hidden = function() return not module:IsClientButtonAvailable("Quests") end}),
	HideGuild = Opt:Toggle({name = L["MicroOptions_Guild"], hidden = function() return not module:IsClientButtonAvailable("Guild") end}),
	HideHousing = Opt:Toggle({name = _G.HOUSING_MICRO_BUTTON or "Housing", hidden = function() return not module:IsClientButtonAvailable("Housing") end}),
	HideLFG = Opt:Toggle({name = L["MicroOptions_LFG"], hidden = function() return not module:IsClientButtonAvailable("LFG") end}),
	HideEJ = Opt:Toggle({name = L["MicroOptions_EJ"], hidden = function() return not module:IsClientButtonAvailable("EJ") end}),
	HideCollections = Opt:Toggle({name = L["MicroOptions_Collections"], hidden = function() return not module:IsClientButtonAvailable("Collections") end}),
	HideStore = Opt:Toggle({name = L["MicroOptions_Store"], hidden = function() return not module:IsClientButtonAvailable("Store") end}),
	...
	Micromenu.args.RaidMenu = Opt:Group({
		...
		args = {
			...
			Enable = Opt:Toggle({
				...
				desc = "Show the raid and group tools attached to the left micromenu button and hide Blizzard's group manager. Disabling this restores Blizzard's manager after combat.",
