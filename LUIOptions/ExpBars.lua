...
ExpBars.args = {
	...
	ShowAzerite = Opt:Toggle({hidden = Opt.LUI.IsForever, name = "Show Azerite XP when Heart of Azeroth is equipped.", width = "full"}),
	...
	AzeriteType = Opt:ColorMenu(colorMenuOptions, {hidden = Opt.LUI.IsForever, name = "Azerite", arg = "Azerite"}),
	HouseFavorType = Opt:ColorMenu(colorMenuOptions, {hidden = Opt.LUI.IsForever, name = "House Favor", arg = "HouseFavor"}),
